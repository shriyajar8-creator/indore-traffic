...
export const CivilianApp: React.FC<CivilianAppProps> = ({ roads, incidents, notifications }) => {
  ...
  // Listen for socket alert broadcast events
  useEffect(() => {
        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h1 className="font-extrabold text-sm text-white tracking-wide uppercase font-sans">
              Indore Traffic Companion
            </h1>
            <p className="text-[10px] text-slate-400">Civilian Real-Time Navigation & Alert System</p>
          </div>
        </div>
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-12 relative">
        ...
        <div className="md:col-span-4 lg:col-span-3 bg-slate-900/95 border-r border-slate-800 p-4 space-y-4 z-20 flex flex-col justify-between overflow-y-auto">
          <div className="space-y-4">
            {/* Search inputs */}
            <div className="bg-slate-950 p-3 rounded-xl border border-slate-800 space-y-2.5 shadow-inner">
            ...
            <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 space-y-3 shadow-lg">
              <div className="flex items-center justify-between border-b border-slate-800 pb-2">
                ...
                <span className="text-xs font-bold text-emerald-400">{origin} → {destination}</span>
              </div>

              <div className="flex items-baseline justify-between">
                <div>
                  <span className="text-2xl font-black text-white font-sans">{routeSwitched ? '18' : '24'} min</span>
                  <span className="text-xs text-slate-400 block">{routeSwitched ? '6.2 km (Via Eastern Bypass)' : '8.7 km (Via AB Road)'}</span>
                </div>
                <div className="text-right">
                  ...
                  <span className="text-[10px] text-slate-400 block">{routeSwitched ? 'Optimized Alternate' : '+7 min delay'}</span>
                </div>
              </div>
          ...
          <div className="text-[10px] text-slate-500 pt-2 border-t border-slate-800">
            Connected to Indore Municipal Traffic Intelligence Core
          </div>
        </div>
